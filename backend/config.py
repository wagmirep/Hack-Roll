...
class Settings(BaseSettings):
    ...
    # External Diarization API (Colab notebook with pyannote)
    # When set, backend calls this API instead of loading local model
    # Usually same URL as TRANSCRIPTION_API_URL (same Colab notebook)
    DIARIZATION_API_URL: Optional[str] = os.getenv("DIARIZATION_API_URL")
