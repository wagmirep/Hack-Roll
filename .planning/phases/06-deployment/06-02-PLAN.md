...
**Prerequisite:** Backend deployed to Fly.io (from Plan 06-01)
...
4. Set env vars in Vercel dashboard or CLI:
   - EXPO_PUBLIC_API_URL=https://fly-url
...
<task type="checkpoint:human-verify" gate="blocking">
  ...
  <how-to-verify>
    ...
    5. Verify: Recording uploads to backend (check network tab or Fly.io logs)
...
- [ ] Can login/signup
- [ ] Recording flow connects to Fly.io backend
</verification>

<success_criteria>
- Expo web deployed to Vercel
- Frontend connects to Fly.io backend
